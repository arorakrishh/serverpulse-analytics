...
if __name__ == "__main__":
    print("ServerPulse Analytics - Data Stream Processing Started ...")

    spark = SparkSession \
        .builder \
        .appName("ServerPulse Analytics - Stream Processor") \
        .master("local[*]") \
        .getOrCreate()
    ...
    print("ServerPulse Analytics - Data Stream Processing Completed.")
